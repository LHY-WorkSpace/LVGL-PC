...
#define LV_USE_BUILTIN_MALLOC 1
    ...
    #define LV_MEM_SIZE (100U * 1024U * 1024U)          /*[bytes]*/
...
#define LV_USE_FS_WIN32 1
    ...
    #define LV_FS_WIN32_PATH "D:\\VSCode\\Other\\LVGL-PC"         /*Set the working directory. File/directory paths will be appended to it.*/
